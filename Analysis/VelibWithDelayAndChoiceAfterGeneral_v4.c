...
*/
    FILE* data = fopen("VelibDelayChoiceAfter.txt", "w");
...
//    run_detailed_system(N, N*15, K, LAMBDA, MU, 1000*N, 1000000); //INT_MAX = 2147483647
    ...
    for(s=0; s<51; s++)
        run_system(N, N*s, K, LAMBDA, MU, 500000, 1000000);
